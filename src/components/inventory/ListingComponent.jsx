...
import { datagridColumns } from "./InventoryConfig";
import { setMenuItem } from "../../redux/actions/NavigationAction";
import { setInventories } from "../../redux/actions/InventoryAction";
...
const ListingComponent = () => {
    ...
    const { listData } = useSelector(state => state.allInventories);
